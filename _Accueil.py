...
st.write("- **Données croisées** : Pour exemple, données croisées en temps réel pour la ville de Tulle. Les débits de la rivière Corrèze ont été croisés avec les relevés de précipitations.")
